"""Fast kernel adapter — wraps existing paper_agent.high_level.translate()."""
...
class LegacyKernel:
    """Kernel adapter for the original paper_agent translation pipeline (fast mode)."""
    ...
    def translate(
        ...
        from paper_agent.doclayout import ModelInstance, OnnxModel
        from paper_agent.high_level import translate
